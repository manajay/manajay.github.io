...
title: 应用被拒
tag: iOS 上架
date: 2016-08-08 11:29:02.000000000 +09:00
---


## 1. 应用名 标题太长 包含关键字 被拒 
[相关开发者文档](https://localizedirect.com/posts/whats-in-a-name)
...
古董古玩文玩艺术品收藏捡漏淘宝二手拍卖鉴定交易担保社交聊天平台
...
遇到这个拒绝理由时，要放弃副标题，老老实实的只写appname，否则还会被打回。
等版本通过，下个版本再改副标题。

// 标题中 包含了 太多的关键字 , 这是不合适的 , 关键字 应该在 关键字的地方
